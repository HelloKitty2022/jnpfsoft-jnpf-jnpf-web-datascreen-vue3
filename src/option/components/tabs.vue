        ...
        <el-collapse-item title="边框设置">
          ...
          <el-form-item label="图片地址">
            <img v-if="main.activeOption.backgroundImage"
              :src="computedImgUrl(main.activeOption.backgroundImage)" alt="" style="width:100%;" />
        ...
        <el-collapse-item title="高亮设置">
          ...
          <el-form-item label="背景图片">
            <img v-if="main.activeOption.empBackgroundImage"
              :src="computedImgUrl(main.activeOption.empBackgroundImage)" alt=""
              style="width:100%;" />
            <el-input clearable v-model="main.activeOption.empBackgroundImage">
              <template #append>
